...
create function public.public_patient_portal_updates_by_phone(target_phone text)
returns jsonb
language sql
security definer
set search_path = public
...
grant execute on function public.public_patient_portal_updates_by_phone(text) to anon;
