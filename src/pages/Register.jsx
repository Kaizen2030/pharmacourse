...
export default function Register() {
  ...
  async function handleRegister(e) {
    ...
    // Insert into user_profiles after successful signup
    if (data?.user) {
        ...
        <form onSubmit={handleRegister}>
          ...
          <div className="form-group">
            ...
            <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
              ...
              <button type="button" onClick={() => setShowConfirm(!showConfirm)} style={{ position: "absolute", right: "12px", background: "none", border: "none", cursor: "pointer", fontSize: "18px", color: "var(--text-500)" }} title={showConfirm ? "Hide password" : "Show password"}>
                {showConfirm ? "👁️" : "👁️‍🗨️"}
              </button>
            </div>
          </div>
