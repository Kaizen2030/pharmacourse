export const DEFAULT_CERTIFICATE_SETTINGS = {
  ...
  signature_role: "Director, RemedacarePOS",
  footer_text: "RemedacarePOS - Professional Pharmacy CPD Platform - www.pharmacourse.co.ke",
  signature_image_url: "",
  left_badge_title: "CPD",
  left_badge_subtitle: "Certified",
  left_vertical_text: "RemedacarePOS Kenya",
}
